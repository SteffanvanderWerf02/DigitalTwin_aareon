...
-- Started on 2023-05-10 08:54:53 UTC
...
--
-- TOC entry 3254 (class 2606 OID 16547)
-- Name: sensor_facilitor Facilitor_id; Type: CONSTRAINT; Schema: dt_emmen; Owner: -
--

ALTER TABLE ONLY dt_emmen.sensor_facilitor
    ADD CONSTRAINT "Facilitor_id" UNIQUE (facilitor_id);
--
...
INSERT INTO dt_emmen.room(building_id, room_number, coordinates, name) VALUES ( 1, 'K50', '383,346 418,346 418,365 383,365', 'Werkruimte' );
...
INSERT INTO dt_emmen.room(building_id, room_number, coordinates, name) VALUES ( 1, 'K48', '460,346 494,346 494,365 460,365', 'Vergaderkamer' );
...
INSERT INTO dt_emmen.room(building_id, room_number, coordinates, name) VALUES ( 1, 'K43', '620,273 666,273 666,308 620,308', 'Technische ruimte' );
...
INSERT INTO dt_emmen.room(building_id, room_number, coordinates, name) VALUES ( 1, '2.10', '369,477 561,477 561,568 369,568', 'Casco');
...
-- Completed on 2023-05-10 08:54:54 UTC
