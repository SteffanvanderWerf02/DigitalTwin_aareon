...
-- Started on 2023-06-20 12:01:15 UTC
...
--
-- TOC entry 3446 (class 1262 OID 16385)
...
--
-- TOC entry 3424 (class 0 OID 16387)
-- Dependencies: 215
...
--
-- TOC entry 3428 (class 0 OID 16400)
-- Dependencies: 219
...
INSERT INTO dt_emmen.room (building_id, room_number, coordinates, image_path, name) VALUES (1, 'K64-2', '9,61 27,61 27,93 9,93', '/images/rooms/K64-2/K64-2.jpg', 'Werkruimte');
...
INSERT INTO dt_emmen.room (building_id, room_number, coordinates, image_path, name) VALUES (1, 'K62-2', '218,8 256,8 256,32 218,32', '/images/rooms/K62-2/K62-2.jpg', 'Werkruimte');
...
INSERT INTO dt_emmen.room (building_id, room_number, coordinates, image_path, name) VALUES (1, 'K60-2', '383,8 421,8 421,33 383,33', '/images/rooms/K60-2/K60-2.jpg', 'Werkruimte');
...
INSERT INTO dt_emmen.sensor (room_number, friendlyname, serial_number, type_id, building_id) VALUES ('K64-2', 'K64-2-CO2', NULL, 2, 1);
...
INSERT INTO dt_emmen.sensor (room_number, friendlyname, serial_number, type_id, building_id) VALUES ('K62-2', 'K62-2-CO2', NULL, 2, 1);
...
INSERT INTO dt_emmen.sensor (room_number, friendlyname, serial_number, type_id, building_id) VALUES ('K60-2', 'K60-2-CO2', NULL, 2, 1);
...
INSERT INTO dt_emmen.sensor (room_number, friendlyname, serial_number, type_id, building_id) VALUES ('K14', 'K14-CO2', NULL, 2, 1);
...
--
-- TOC entry 3432 (class 0 OID 16411)
-- Dependencies: 223
...
--
-- TOC entry 3433 (class 0 OID 16415)
-- Dependencies: 224
...
--
-- TOC entry 3434 (class 0 OID 16419)
-- Dependencies: 225
...
INSERT INTO dt_emmen.sensor_facilitor (id, sensor_id, facilitor_id, data_type_id) VALUES (116, 'K14-CO2', 18776, 3);


--
-- TOC entry 3436 (class 0 OID 16425)
-- Dependencies: 227
...
--
-- TOC entry 3437 (class 0 OID 16429)
-- Dependencies: 228
...
--
-- TOC entry 3439 (class 0 OID 16435)
-- Dependencies: 230
...
INSERT INTO dt_emmen."user" (mail, role_id, password, mfa_token, username) VALUES ('administrator@aareon.nl', 2, '89fb2117ff321068f31f9cc84f8631e5a084634db39207613f960a41dde704ff', '', 'Steffan');
...
SELECT pg_catalog.setval('dt_emmen.building_id_seq', 2, true);
...
--
-- TOC entry 3258 (class 2606 OID 16536)
-- Name: sensor_facilitor sensor_facilitor_facilitor_id_facilitor_id1_key; Type: CONSTRAINT; Schema: dt_emmen; Owner: -
--

ALTER TABLE ONLY dt_emmen.sensor_facilitor
    ADD CONSTRAINT sensor_facilitor_facilitor_id_facilitor_id1_key UNIQUE (facilitor_id) INCLUDE (facilitor_id);
...
--
-- TOC entry 3265 (class 2606 OID 16469)
...
--
-- TOC entry 3266 (class 1259 OID 16472)
...
--
-- TOC entry 3261 (class 1259 OID 16476)
...
--
-- TOC entry 3271 (class 1259 OID 16480)
...
--
-- TOC entry 3280 (class 2606 OID 16481)
...
--
-- TOC entry 3275 (class 2606 OID 16486)
...
--
-- TOC entry 3279 (class 2606 OID 16496)
...
--
-- TOC entry 3277 (class 2606 OID 16501)
...
--
-- TOC entry 3278 (class 2606 OID 16506)
...
--
-- TOC entry 3272 (class 2606 OID 16516)
...
-- Completed on 2023-06-20 12:01:15 UTC
